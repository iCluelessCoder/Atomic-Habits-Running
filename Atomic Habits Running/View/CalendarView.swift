...
//
//  Created by Marek Justus on 13/05/2019.
//  Copyright © 2019 Marek Justus. All rights reserved.
//

import UIKit

    let viewControllerInterface = ViewController()

struct Colors {
    static var darkGray = #colorLiteral(red: 0.3764705882, green: 0.3647058824, blue: 0.3647058824, alpha: 1)
    static var lightBlue = #colorLiteral(red: 0.01809175313, green: 0.4697962403, blue: 0.9865134358, alpha: 1)
}
...
class CalenderView: UIView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, MonthViewDelegate {
    ...
    var presentYear = 0
    var todaysDate = 0
    var firstWeekDayOfMonth = 0   //(Monday-Sunday 1-7)
    var daysSelected = 0
